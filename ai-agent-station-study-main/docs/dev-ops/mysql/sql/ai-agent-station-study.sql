...
CREATE TABLE `ai_agent` (
  ...
  `strategy` varchar(64) DEFAULT 'autoAgentExecuteStrategy' COMMENT '执行策略(autoAgentExecuteStrategy、flowAgentExecuteStrategy)',
...
VALUES
	(6,'1','GitHub智能体（Flow）','GitHub任务自动化处理','agent','flowAgentExecuteStrategy',1,'2025-06-14 12:41:20','2025-08-24 16:41:24'),
	(7,'2','文件系统操作智能体（MCP）','文件系统操作，工具服务','agent','autoAgentExecuteStrategy',1,'2025-06-14 12:41:20','2025-06-14 12:41:20'),
	(8,'3','智能问答主体（Auto）','支持知识库检索和网页搜索的智能问答系统','agent','autoAgentExecuteStrategy',1,'2025-06-14 12:41:20','2025-08-09 10:55:46'),
...
VALUES
	(2,'3','3101','意图分析与需求理解','TASK_ANALYZER_CLIENT',1,'**用户问题:** %s
 **分析要求:**
 ...
 **输出格式要求:**
 ...
 任务状态: [CONTINUE/COMPLETED]',1,'2025-06-14 12:42:20'),
	(3,'3','3102','知识库检索执行','PRECISION_EXECUTOR_CLIENT',2,'**用户问题:** %s
 **分析师策略:** %s
 ...
 **输出格式:**
 ...
 质量检查: [对检索结果的质量评估]',1,'2025-06-14 12:42:20'),
	(4,'3','3103','网页搜索执行','QUALITY_SUPERVISOR_CLIENT',3,'**用户问题:** %s
 **分析师策略:** %s
 ...
 **输出格式:**
 ...
 质量检查: [对搜索结果的质量评估]',1,'2025-06-14 12:42:20'),
	(5,'3','3104','结果整合与智能回答','RESPONSE_ASSISTANT',4,'**用户问题:** %s
 **知识库检索结果:** %s
 **网页搜索结果:** %s
 **整合要求:**
 ...
 **输出格式:**
 ...
 质量评估: [对最终答案的质量评估]',1,'2025-06-14 12:42:20'),
	...
	(14,'1','2101','意图识别','INTENT_ANALYZER_CLIENT',1,'识别用户GitHub操作意图的提示词',1,'2025-06-14 12:42:20'),
	(15,'1','2102','GitHub工具能力分析','TOOL_ANALYZER_CLIENT',2,'分析GitHub MCP工具可用能力的提示词',1,'2025-06-14 12:42:20'),
	(16,'1','2103','GitHub工具调用','TOOL_EXECUTOR_CLIENT',3,'执行GitHub相关操作的提示词',1,'2025-06-14 12:42:20'),
	(17,'1','2104','响应构建','RESPONSE_BUILDER_CLIENT',4,'构建和格式化响应结果的提示词',1,'2025-06-14 12:42:20');

-- 为 agent_id=2（文件系统操作智能体）补充流程步骤
INSERT INTO `ai_agent_flow_config` (`id`, `agent_id`, `client_id`, `client_name`, `client_type`, `sequence`, `step_prompt`, `status`, `create_time`)
VALUES
	(18,'2','2201','文件系统操作助手','PRECISION_EXECUTOR_CLIENT',1,'处理文件系统相关操作的提示词',1,'2025-06-14 12:42:20');
...
VALUES
	(1,'2101','意图识别','识别用户GitHub操作意图',1,'2025-06-14 12:34:36','2025-08-24 15:01:40'),
	(2,'2102','GitHub工具能力分析','分析GitHub MCP工具可用能力',1,'2025-06-14 12:43:02','2025-08-24 15:02:28'),
	(3,'2103','GitHub工具调用','执行GitHub相关操作',1,'2025-06-14 12:43:02','2025-08-24 15:02:29'),
	(4,'2104','响应构建','构建和格式化响应结果',1,'2025-06-14 12:43:02','2025-08-24 15:02:30'),
	(11,'3101','意图分析与需求理解','智能问答意图分析专家，负责分析用户问题类型和制定检索策略',1,'2025-06-14 12:43:02','2025-07-27 17:00:55'),
	(12,'3102','知识库检索执行','知识库检索专家，负责从RAG知识库中检索相关信息',1,'2025-06-14 12:43:02','2025-07-27 17:01:10'),
	(13,'3103','网页搜索执行','网页搜索专家，负责使用百度搜索获取最新网络信息',1,'2025-06-14 12:43:02','2025-07-27 17:01:23'),
	(14,'3104','结果整合与智能回答','智能回答专家，负责整合知识库和网页搜索结果生成最终答案',1,'2025-06-14 12:43:02','2025-08-07 14:16:47'),
	...
	(23, '2201','文件系统操作助手', '处理文件系统相关操作（如文件读写、目录管理、文件搜索）',1,'2025-09-14 12:43:02','2025-09-14 14:16:47');
...
VALUES
	(1,'1001','https://open.bigmodel.cn/api/paas/','c259c3bbdeb449e7b0673c8f393006ab.iPaHfYyhLddTiOw5','v4/chat/completions','v4/embeddings',1,'2025-06-14 12:33:22','2025-08-24 15:16:27');
...
VALUES
	...
	(13,'client','3101','advisor','4002','\"\"',1,'2025-06-14 12:46:49','2025-07-27 17:05:08'),
	...
	(17,'client','3102','advisor','4002','\"\"',1,'2025-06-14 12:46:49','2025-07-27 17:05:08'),
	...
	(21,'client','3103','advisor','4002','\"\"',1,'2025-06-14 12:46:49','2025-07-27 17:05:08'),
	...
	(76,'client','3104','advisor','4001','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:53'),
	(77,'client','3104','advisor','4002','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:54'),
	...
	(75,'client','2103','tool_mcp','5009','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:55'),
	(68,'client','2104','model','2000','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:54'),
	(69,'client','2104','prompt','6004','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:54'),
	(70,'client','2104','advisor','4001','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:54'),
	(71,'client', '2201', 'model', '3001','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:53'),
	(72,'client', '2201', 'prompt', '6201','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:53'),
	(73,'client', '2201',  'tool_mcp', '5003','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:53'),
	(74,'client', '2201',  'advisor', '4001','\"\"',1,'2025-06-14 12:46:49','2025-08-17 12:44:53');
...
VALUES
	(1,'2000','1001','glm-4.5','openai',1,'2025-06-14 12:33:47','2025-08-17 11:29:11'),
	(2,'2001','1001','glm-4','openai',1,'2025-06-14 12:33:47','2025-08-17 11:29:09'),
	(3,'3001','1001','glm-4.5','openai',1,'2025-06-14 12:33:47','2025-08-17 12:42:38'),
	(4,'4001','1001','glm-4.5','openai',1,'2025-06-14 12:33:47','2025-08-17 12:45:10'),
	(5,'5001','1001','glm-4.5','openai',1,'2025-06-14 12:33:47','2025-08-17 12:45:12');
...
VALUES
	...
	(23, '6201','GitHub任务分析', '你是一名专业的 GitHub 智能助手，负责帮助用户完成与 GitHub 仓库相关的各类任务。你的主要能力包括：

1. Issue 管理\n- 查询、检索、总结 GitHub 仓库中的 Issue
   - 辅助用户分析问题状态、优先级和进展  
   - 给出解决问题的策略建议  
...
3. 代码与提交历史分析  
   - 检索提交记录，提取重要变更内容  
   - 帮助用户快速理解某次提交或一系列提交的影响  
   - 结合上下文总结开发进展和趋势  

4. 项目协作与任务分配  
   - 通过分析 Issue / PR，协助生成任务清单  
   - 提供合理的优先级排序建议  
   - 支持项目进度的阶段性总结与报告  

5. 响应式支持  
   - 对用户提出的即时问题，快速从 GitHub 数据中检索答案  
   - 如无法直接获取信息，应引导用户提供仓库名、组织名、分支名等必要参数  

### 行为准则
- 保持简洁清晰的回答，必要时分步骤说明  
- 避免冗余，突出重点信息  
- 在需要调用 MCP 工具时，应正确生成请求并解释调用目的  
- 确保结果可执行、可落地，避免泛泛而谈  

### 输出格式
- 当返回列表数据时，使用项目符号或表格展示  
- 当提供分析或建议时，给出 **结论 + 理由**  
- 当涉及步骤操作时，给出 **Step 1, Step 2, Step 3...** 的清晰结构  

你的目标是成为用户在 GitHub 上的高效协作助手，既能提供数据查询，也能进行任务分析与建议。', 'GitHub智能助手', 1, '2025-08-08 10:00:00', '2025-08-16 13:03:11');
